...
- Comparison of seismic assessment methods for reinforced concrete buildings.
- Supervisor: Prof. Dr. Raquib Ahsan, BUET

**B.Sc. Research**  
2020 – 2021  

- Seismic vulnerability assessment of an existing RC building.
- Supervisor: Dr. Debasish Sen, AUST

**Other Research Works**  
2022 – Present  

- Seismic assessment of existing buildings
- Machine-learning-based strength prediction of ultra-high-performance concrete
- Data-driven estimation of the fundamental period in steel-braced reinforced concrete frames
...
<div style="display: flex; gap: 60px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 280px;">
    ...
    <ul>
      <li>Mechanics of Solids I</li>
      <li>Mechanics of Solids II</li>
      <li>Analysis of Statically Determinate Structures</li>
      <li>Design of Steel Structures</li>
    </ul>
  </div>

  <div style="flex: 1; min-width: 280px;">
    <h3>Sessional Courses</h3>
    <ul>
      <li>Design of Concrete Structures Sessional I</li>
      <li>Design of Concrete Structures Sessional II</li>
      <li>Design of Steel Structures Sessional</li>
    </ul>
  </div>
...
- Scholarship of Tk. 30,000 from the Pubali Bank Staff Welfare Fund for obtaining GPA 5.00 in the SSC examination.
- Certificate from Janata Bank Ltd. for obtaining brilliant results in the HSC examination.

## Co-curricular and Extra-curricular Activities

- Planned and organized Civil Job Fiesta 2019, organized by AUST Civil Engineering Society.
- General member of AUST Blood Donation Club.

## Seminars and Workshops

- Seminar on "Earthquake Vulnerability Structures in Bangladesh and Design Considerations", MH Khan Auditorium, Ahsanullah University of Science and Technology.

## Online Profiles

- [Google Scholar](https://scholar.google.com/citations?hl=en&user=_MDkhacAAAAJ)
- [Scopus](https://www.scopus.com/authid/detail.uri?authorId=58338983300)
- [ORCID](https://orcid.org/0009-0004-2499-4772)
- [ResearchGate](https://www.researchgate.net/profile/Md-Farhad-Momin)
- [LinkedIn](https://bd.linkedin.com/in/mdfarhadmomin)
